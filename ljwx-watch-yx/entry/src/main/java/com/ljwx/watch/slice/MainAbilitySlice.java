package com.ljwx.watch.slice;

import com.ljwx.watch.MainAbility;
import com.ljwx.watch.ResourceTable;
import com.ljwx.watch.custom.BTCircularDashboard;
import com.ljwx.watch.custom.CircularDashboard;
...
public class MainAbilitySlice extends AbilitySlice {
    ...
    public void runBluetooth(){
        ...
        Operation btOperation = new Intent.OperationBuilder()
                .withDeviceId("")
                .withBundleName("com.ljwx.watch")
                .withAbilityName("com.ljwx.watch.BluetoothService")
                .build();
    ...
    public void runHttp(){
        ...
        Operation httpOperation = new Intent.OperationBuilder()
                .withDeviceId("")
                .withBundleName("com.ljwx.watch")
                .withAbilityName("com.ljwx.watch.HttpService")
                .build();
    ...
    public void runHealthData(){
        ...
        Operation HdOperation = new Intent.OperationBuilder()
                .withDeviceId("")
                .withBundleName("com.ljwx.watch")
                .withAbilityName("com.ljwx.watch.HealthDataService")
                .build();   
